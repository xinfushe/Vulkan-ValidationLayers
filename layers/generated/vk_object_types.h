...
static inline VkObjectType ConvertVulkanObjectToCoreObject(VulkanObjectType internal_type) {
    switch (internal_type) {
        ...
        case kVulkanObjectTypeObjectTableNVX: return VK_OBJECT_TYPE_OBJECT_TABLE_NVX;
        case kVulkanObjectTypeIndirectCommandsLayoutNVX: return VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NVX;
